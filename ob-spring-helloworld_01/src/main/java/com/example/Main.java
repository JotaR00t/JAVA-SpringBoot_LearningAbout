...
public class Main {
    public static void main(String[] args) {
        ...
        CalculatorService calculator = (CalculatorService) context.getBean("beanCalculatorService");
        //esto debe mostrar 1 vez "hola jc"
        String texto = calculator.holaJc();
        System.out.println(texto);

        //EJEMPLO 2
         FactureGestor gestor = (FactureGestor) context.getBean("beanFactureGestor");
